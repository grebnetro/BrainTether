...
import { Volume2, VolumeX, Play, Pause, CloudRain, Waves, Radio } from 'lucide-react';
...
export const AmbientPlayer: React.FC = () => {
  ...
  return (
    <div className="p-4 rounded-2xl bg-slate-900/90 border border-teal-500/30 text-white shadow-lg space-y-3">
