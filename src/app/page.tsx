      ...
      <section className="relative pt-16 pb-24 px-6 overflow-hidden text-center">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex flex-col items-center justify-center space-y-3 pt-2">
            <Link
              href="/dashboard"
              className="flex items-center space-x-2 px-8 py-4 text-base font-bold text-white rounded-2xl bg-gradient-to-r from-teal-500 to-emerald-600 hover:from-teal-600 hover:to-emerald-700 shadow-xl shadow-teal-500/25 active:scale-95 transition-all"
            >
            ...
            <p className="text-xs text-slate-400">
              ...
              <Link href="/auth/signin" className="text-teal-400 font-semibold hover:underline">
        ...
        {/* Interactive Stress Point Calculator Demo */}
